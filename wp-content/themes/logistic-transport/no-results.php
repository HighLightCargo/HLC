...
<header role="banner">
	<h2 class="entry-title"><?php esc_html_e( 'Nothing Found', 'logistic-transport' ); ?></h2>
</header>
...
<?php if ( is_home() && current_user_can( 'publish_posts' ) ) : ?>
	...
	<?php else : ?>
		...
		<div class="read-moresec">
			<a href="<?php echo esc_url( home_url() ); ?>" class="button hvr-sweep-to-right"><?php esc_html_e( 'Back to Home Page', 'logistic-transport' ); ?><span class="screen-reader-text"><?php esc_html_e( 'Back to Home Page', 'logistic-transport');?></span></a>
		</div>
<?php endif; ?>