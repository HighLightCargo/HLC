...
function transportation_font_url(){
		...
		*/
		$karla = _x('on', 'Karla font:on or off','transportation');
		
		/* Translators: If there are any character that are
		* not supported by Roboto, translate this to off, do not
		* translate into your own language.
		*/
		$roboto = _x('on', 'Roboto font:on or off','transportation');
		
		/* Translators: If there are any character that are
		* not supported by Montserrat, translate this to off, do not
		* translate into your own language.
		*/
		$montserrat = _x('on', 'Montserrat font:on or off','transportation');
		
		
		
		if('off' !== $karla || 'off' !== $roboto || 'off' !== $montserrat){
			$font_family = array();
